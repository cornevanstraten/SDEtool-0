...
$email_subject = "SDEtool spreadsheet";
$email_body = "<p>Beste gebruiker van SDEtool, </p>\n\n"."<p>Hartelijk dank voor uw interesse in onze tools om eenvoudiger uw SDE+ subsidie te berekenen. Naar aanleiding van het invullen van onze SDEtool sturen wij u hierbij een uitgebreide Excel sheet toe waarmee u beschikt over alle relevante informatie met betrekking tot uw business case (<a href='http://sdetool.nl/SDE_spreadsheet.xlsx'>download</a>). Met deze werkmap kunt u tot in detail zien hoe uw business case er uitziet; en kunt u verschillende scenario's vergelijken op basis van twee verschillende basisbedragen. Op grafische wijze is weergegeven van welke vermeden kosten, subsidieopbrengsten en terugleveringsopbrengsten u uit kunt gaan. </p> \n\n ". "<p>Wij hopen dat de SDEtool en de uitgebreide berekening van uw business case u verder helpen met het realiseren van uw project! Mocht u naar aanleiding van de casus en/of de regeling nog vragen hebben, dan zijn wij u graag van dienst. </p> \n\n". "<p>Met vriendelijke groeten, </p>\n\n". "<p>Jim Damen </p>\n\n". "<p>jimdamen@balance.nl </p>\n\n". "<p>+31 639190647</p>".
...
$email_subject2 = "sdetool lead";
$email_body2 = "Je hebt een nieuw bericht van het contactformulier\n\n"."Hier is de contactinformatie: Email: $email_ingevuld\n\nTelefoon: $telefoon\n";
...
$email_subject3 = "sdetool lead";
$email_body3 = "Je hebt een nieuw bericht van het contactformulier\n\n"."Hier is de contactinformatie: Email: $email_ingevuld\n\nTelefoon: $telefoon\n";
$headers3 = "From: info@sdetool.nl\n"; // This is the email address the generated message will be from. We recommend using something like noreply@yourdomain.com.
$headers3 .= "Reply-To: $email_jim";


mail($to3,$email_subject3,$email_body3,$headers3);

$to4 = 'subsidies@balance.nl';
$email_subject4 = "sdetool lead";
$email_body4 = "Je hebt een nieuw bericht van het contactformulier\n\n"."Hier is de contactinformatie: Email: $email_ingevuld\n\nTelefoon: $telefoon\n";
$headers4 = "From: info@sdetool.nl\n"; // This is the email address the generated message will be from. We recommend using something like noreply@yourdomain.com.
$headers4 .= "Reply-To: 'subsidies@balance.nl'";

mail($to4,$email_subject4,$email_body4,$headers4);
      ...
      <div class="container">
        <div class="intro-text">
          <div id="flash" class="alert alert-success alert-dismissable text-center">
            ...
            <strong>E-mail verzonden naar <?php echo $email_ingevuld; ?>!</strong>
          </div>
